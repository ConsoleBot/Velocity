  ...
  <div class="section-hero h-full pt-[100px] sm:pt-[142px] md:pt-[133px] lg:pt-[176px] xl:pt-[176px] pb-[64px] bg-center bg-cover bg-no-repeat" style="background-image: url('<?php echo esc_url($product_hero_background_overlay); ?>');">
    <div class="text-center h-[372px] sm:h-[525px] md:h-[634px] lg:h-[860px] xl:h-[892px] 2xl:h-[942px]">
      ...
      <h1 data-animate="animate-once animate-fill-both animate-duration-[1000ms]" class="hero-tagline-2 mt-[-15px] text-[32px] md:text-[96px] lg:text-[150px] xl:text-[200px] font-extrabold leading-[80px] sm:leading-[114px] md:leading-[148px] lg:leading-[182px] bg-[linear-gradient(90deg,#BFD99F_0%,#99EBD7_25%,#9BE0E0_50%,#BFEADB_75%,#D6DAB8_100%)] bg-clip-text text-transparent">DATABASE</h1>
  ...
  <section class="section-hero-after min-h-unset lg:min-h-[1024px] block lg:flex mt-[694px] sm:mt-[894px] md:mt-[1034px] lg:mt-[1203px] xl:mt-[1292px] 2xl:mt-[1342px]">
    <div class="bg-[#191919] lg:rounded-br-[24px] h-[1024px] lg:h-auto w-full lg:w-[54.6%] pt-[64px] lg:pt-[114px] pl-[16px] lg:pl-[120px] pr-[16px] lg:pr-[80px]">
      ...
      <p data-animate="animate-fade-up animate-once animate-fill-both" class="font-inter max-w-[586px] text-[16px] text-[#FEFEFE] leading-[157%] tracking-[0.15px] mb-[50px]">Our platform simplifies property management with an intuitive dashboard, automated leases and payments, real-time maintenance tracking, and powerful reporting tools.</p>
      <?php
        $page_id = 40;
        $key_feature_photo = get_field('product_key_feature_photo', $page_id);

        if ($key_feature_photo) {
          echo '<img data-animate="animate-fade-up animate-once animate-fill-both" src="'.esc_url($key_feature_photo).'" class="pointer-events-none object-[25%_0] w-[calc(100% - 16px)] object-cover sm:object-fill sm:object-unset md:static z-1 sm:w-[439px] h-[306px] left-[16px] lg:left-[50px] lg:h-[710px] lg:w-[77.8%] absolute lg:absolute" alt="Screen">';
        }
      ?>
    </div>
    <div class="bg-[#EDF2F7] h-[1260px] lg:h-auto flex-1 pt-0 lg:pt-[80px] pl-[16px] lg:pl-[50px] pr-[16px] lg:pr-[120px] relative">
      <div class="px-0 border-b-2 border-b-[#CCD6E0] lg:px-[12px] max-h-unset lg:max-h-[753px] w-[90%] lg:w-full lg:overflow-y-auto mb-[24px] absolute lg:static h-full overflow-y-visible top-[-360px]">
        <?php
          $page_id = 40;
