<?php get_header(); ?>
    ...
    <div class="container px-0! md:px-[16]!">
      <div class="md:flex items-center py-[64px] md:py-[80px] gap-[16px]">
        ...
        <div class="px-[16px] md:px-0 flex flex-col items-start max-w-[546px] md:ml-auto flex-1 mt-[31px] md:mt-[20%]">
          ...
          <p data-animate="animate-fade-left animation-delay-[300]" class="mb-[16px] text-[#4A5C60] text-[16px] leading-[157%] tracking-[0.15px]">Real estate is typically the largest or second largest expenditure on a company’s income statement. For many companies, the portfolio offers an untapped opportunity to reduce costs, drive efficiencies, and improve the employee experience.</p>
          <p data-animate="animate-fade-left animation-delay-[400]" class="text-[#4A5C60] text-[16px] leading-[157%] tracking-[0.15px]">Modern portfolios are often managed with antiquated tools, making this data difficult to access or quite simply not available. </p>
        </div>
      </div>
    </div>
  </section>
  <section class="relative">
    ...
    <div class="container">
      <div class="pt-[64px] pb-[192px] md:py-[80px] md:pb-[174px] flex items-center flex-col">
        ...
        <p data-animate="animate-fade-down animation-delay-[400]" class="max-w-[792px] text-center mb-[64px] text-[#4A5C60] text-[16px] leading-[157%] tracking-[0.15px]">Velocity Properties is a cutting-edge application suite that will address Real Estate Management by providing these products and services.</p>
  ...
  <section>
    <div class="flex flex-col items-center relative pt-0 md:pt-[48px] pb-[112px] md:pb-[120px]">
      ...
      <p data-animate="animate-fade-down animation-delay-[400]" class="max-w-[660px] text-center mb-[32px] md:mb-[80px] text-[#4A5C60] text-[16px] leading-[157%] tracking-[0.15px]">Get to know the faces behind our accomplishments and explore the collective dedication that defines us.</p>
              ...
              if (!empty($member['name'])) {
                echo '<div class="flex flex-col text-center md:text-left md:flex-row flex-wrap items-center justify-center gap-[8px] md:gap-[24px]">';
                  ...
                  echo '<div class="flex-1 min-w-[200px] max-w-[300px]">';
                    ...
                    echo '<p style="animation-delay: '.($delay + 200).'ms" data-animate="animate-fade-down" class="text-[14px] text-[#4A5C60] leading-[1] tracking-[0.2px] mb-[16px] md:mb-[24px]">'.esc_html($member['position']).'</p>';
                    echo '<p style="animation-delay: '.($delay + 300).'ms" data-animate="animate-fade-down" class="text-[16px] text-[#4A5C60] leading-[157%] tracking-[0.15px]">'.esc_html($member['description']).'</p>';
                  echo '</div>';
                echo '</div>';
              }
              $delay += 500;
