...
<body <?php body_class(); ?>>
  <div id="page" class="min-h-screen flex flex-col bg-[#262829]">
    <header class="fixed w-full top-0 h-[56px] md:h-[96px] black">
      <section class="h-full">
        <div class="container flex items-center md:items-end justify-between">
          ...
          ?>
          <div class="header-container bg-[#FEFEFE1A] hidden md:flex items-center justify-between w-full  h-[78px] rounded-[100px] border-[1px] border-[#FEFEFE1A] px-[16px] ml-auto max-w-[628.79px]">
            <?php 
              wp_nav_menu([
