<?php
  /**
   * Template Name: Lease Administration Template
   */
  get_header();
  ?>
  <?php
  ...
  <div class="section-hero h-full pt-[100px] sm:pt-[142px] md:pt-[133px] lg:pt-[176px] xl:pt-[176px] pb-[64px] bg-center bg-cover bg-no-repeat" style="background-image: url('<?php echo esc_url($product_hero_background_overlay); ?>');">
    <div class="text-center h-[372px] sm:h-[525px] md:h-[634px] lg:h-[860px] xl:h-[892px] 2xl:h-[942px]">
      ...
      <h2 data-animate="animate-once animate-fill-both animate-duration-[1000ms]" class="hero-tagline-1 text-[24px] sm:text-[36px] md:text-[48px] lg:text-[64px] font-extrabold tracking-[8px] bg-[linear-gradient(90deg,#FF7C6E_0%,#FF63DE_50%,#5496FF_100%)] bg-clip-text text-transparent">LEASE</h2>
      <h1 data-animate="animate-once animate-fill-both animate-duration-[1000ms]" class="hero-tagline-2 mt-[-15px] text-[32px] sm:text-[64px] md:text-[96px] lg:text-[120px] xl:text-[136px] tracking-[0.2px] font-extrabold leading-[80px] sm:leading-[114px] md:leading-[148px] lg:leading-[182px] bg-[linear-gradient(90deg,#FF7C6E_0%,#FF63DE_50%,#5496FF_100%)] bg-clip-text text-transparent">ADMINISTRATION</h1>
    ...
    <div class="overflow-hidden h-[960px] sm:h-[1200px] text-center flex flex-col items-center bg-[#6478F7]">
      ...
      <?php
        ...
        if ($key_feature_photo) {
          echo '<img data-animate="animate-fade-up animate-once animate-fill-both" src="'.esc_url($key_feature_photo).'" class="ml-[12%] z-1 pointer-events-none" alt="Screen">';
        }
      ?>
    </div>
    <div class="bg-[#7A8BF8]">
      <div class="mx-auto h-[2200px] sm:h-[1600px] md:h-[1500px] lg:h-[900px] xl:h-[747px] max-w-[1200px] relative">
        <div class="px-[16px] absolute top-[-200px] sm:top-[-190px] flex md:grid grid-cols-[repeat(auto-fill,minmax(373px,1fr))] gap-[24px] flex-wrap">
          <?php
            $page_id = 52;
            ...
            if ($product_key_features) {
              foreach ($product_key_features as $index => $key_feature) {
                echo '<div data-animate="animate-fade-left animate-once animate-fill-both" class="p-[24px] lg:p-[32px] bg-[#F8FAFC] border border-[#CCD6E0] rounded-[16px]">';
                  echo '<div class="bg-[#ECEEFE] rounded-full w-[64px] h-[64px] flex items-center justify-center mb-[16px]">';
                    echo '<div style="background-image: url(' . esc_url($key_feature['icon']) . ');" class="bg-cover bg-center w-[32px] h-[32px]"></div>';
                  echo '</div>';
                  echo '<h3 class="text-[#000000] text-[24px] font-extrabold tracking-[0.2px] mb-[16px]">' . esc_html($key_feature['name']) . '</h3>';
